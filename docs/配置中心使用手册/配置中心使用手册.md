...
```shell
./cfgtool create offline -v 0.0.1 -e 00 -c DTP.MC.set0 -g 0 -l 1 -t template_00.toml \
...
```shell
./cfgtool create online -v 0.0.1 -e 00 -c DTP.MC.set0 -g 0 -l 1 \
...
```shell
./cfgtool get -u chqr -v 0.0.1 -e 00 -c DTP.MC.set0 -t templates -o /Users/chenqr/Desktop/res
```
