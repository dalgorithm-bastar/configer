	...
	tests := []struct {
		...
		},
		{
			...
			args: args{
				req: &pb.CfgReq{
					UserName: "chqr",
					Target:   []string{template.Templates},
					CfgVersions: []*pb.CfgVersion{
						{
							Version: "0.0.1",
							Envs: []*pb.Environment{
		...
		},
		{
			...
			args: args{
				req: &pb.CfgReq{
					UserName: "chqr",
					Target:   []string{template.Services},
					CfgVersions: []*pb.CfgVersion{
						{
							Version: "0.0.1",
							Envs: []*pb.Environment{
		...
		{
			name: template.Manipulations,
			args: args{
				req: &pb.CfgReq{
					UserName: "chqr",
					Target:   []string{template.Manipulations},
					CfgVersions: []*pb.CfgVersion{
						{
							Version: "0.0.1",
							Envs: []*pb.Environment{
...
func Test_checkData(t *testing.T) {
	...
	tests := []struct {
		...
		{
			name: template.NodeConfig + " nromal",
			args: args{
				tag: template.NodeConfig,
				data: []*pb.CfgVersion{
					{
						Version: "0.0.1",
						Envs: []*pb.Environment{
		...
		{
			name: template.NodeConfig + " nromal err",
			args: args{
				tag: template.NodeConfig,
				data: []*pb.CfgVersion{
					{
		...
		{
			name: template.NodeConfig + " globalid err",
			args: args{
				tag: template.NodeConfig,
				data: []*pb.CfgVersion{
					{
		...
		{
			name: template.NodeConfig + " localid err",
			args: args{
				tag: template.NodeConfig,
				data: []*pb.CfgVersion{
					{
		...
		{
			name: template.Templates + " nromal",
			args: args{
		...
		{
			name: template.Templates + " nromal err",
			args: args{
				tag: template.Templates,
				data: []*pb.CfgVersion{
					{
		...
		{
			name: template.Clusters + " nromal",
			args: args{
				tag: template.Clusters,
				data: []*pb.CfgVersion{
					{
						Version: "0.0.1",
						Envs: []*pb.Environment{
		...
		{
			name: template.Clusters + " nromal err",
			args: args{
				tag: template.Clusters,
				data: []*pb.CfgVersion{
					{
		...
		{
			name: template.Infrastructure + " nromal",
			args: args{
				tag: template.Infrastructure,
				data: []*pb.CfgVersion{
					{
						Version: "0.0.1",
						Envs: []*pb.Environment{
		...
		{
			name: template.Infrastructure + " nromal err",
			args: args{
				tag:  template.Infrastructure,
				data: []*pb.CfgVersion{},
			},
...
func Test_getDeploymentInfo(t *testing.T) {
	...
	patchesGetDeploymentInfo := gomonkey.ApplyFuncSeq(template.GetDeploymentInfo, outputsGetDeploymentInfo)
