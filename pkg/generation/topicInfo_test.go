...
func TestGenerateTopicInfo(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			got, err := GenerateTopicInfo(tt.args.dplyStructList, tt.args.rawSlice, tt.args.ipRange, tt.args.portRange, tt.args.envNum)
			if (err != nil) != tt.wantErr {
...
func Test_getNextListenPort(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			gotActualListenPort, gotCoverPort, gotOverFlow := getNextListenPort(tt.args.inputPort, tt.args.envNum, tt.args.listenPortMap)
