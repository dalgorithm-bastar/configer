...
const (
	infraPath = "../../unittestfiles/pkgs/pkg3/infrastructure.yaml"
	cfgPath   = "../../unittestfiles/pkgs/pkg3/3.1.0"
)
...
func TestGenerate(t *testing.T) {
	...
	repository.NewStorage(context.Background(), repository.DirType,
		"../../unittestfiles/res/pkg3res/3.1.0_scheme1")
	...
	tests := []struct {
	...
	}{
		{
			...
			args: args{
				...
				rawData:        rawData,
				envNum:         "01",
				ipRange:        []string{"156.10.1.1", "156.10.11.2"},
				portRange:      []string{"10000", "32768"},
			},
			want:    resMap,
			wantErr: false,
		},
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			_, err := Generate(tt.args.infrastructure, tt.args.rawData, tt.args.envNum, tt.args.ipRange, tt.args.portRange)
